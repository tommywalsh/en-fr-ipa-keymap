...
| Right "super" plus this key... | ... generates this character |
|:------------------------------:|:----------------------------:|
|               o                |              œ               |
|               a                |              æ               |
|        < (shift-comma)         |              «               |
...
| For this accent | Use right "super" plus: |
|:---------------:|:-----------------------:|
| aigu (é)        |    single-quote (')     |
| grave (è)       |      backtick (`)       |
| circonflex (ê)  |        carat (^)        |
...
There are two system files of note: 
  ...
  - The "evdev" rules XML file. I'm not 100% clear on EXACTLY what this file's job is, but it appears to be involved in 
    ...
    called "base". It's my understanding that "evdev" is used with Linux, and perhaps some others I'm not sure which
    systems use "base", or if any in fact still do.
